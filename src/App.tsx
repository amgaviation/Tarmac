        ...
        <div className="relative flex h-full flex-col">
          ...
          >
            <div className="-mt-28 max-w-5xl md:-mt-24">
              ...
              <p className="mb-4 text-sm font-semibold uppercase tracking-widest text-[#9A92D1]">
              ...
              <h1 className="mx-auto text-5xl font-black leading-none tracking-tight text-[#F5F5F5] md:text-7xl lg:text-8xl">
                <span className="block text-[#8A8A8A]">Charter.</span>
                <span className="-mt-2 block text-[#F5F5F5] md:-mt-3">Handled.</span>
              </h1>
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-col gap-4 md:items-end">
            ...
            <img
              ...
              alt="AMG Aviation"
              className="h-10 w-32 object-contain brightness-0 invert opacity-60 md:h-12 md:w-40"
            />
          </div>
        </div>
      </section>
